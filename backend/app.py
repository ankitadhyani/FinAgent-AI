...
def to_frontend_transaction(row: dict, idx: int) -> dict:
    ...
    frontend_txn = {
        ...
        "prev_origin_lat": row.get("prev_origin_lat"),
        "prev_origin_long": row.get("prev_origin_long"),
        "home_distance_km": row.get("home_distance_km"),
        "geo_distance_km": row.get("geo_distance_km"),
        "travel_speed_kmh": row.get("travel_speed_kmh"),
