...
if __name__ == "__main__":
    ...
    merchant_result_normal = analyze_merchant(normal_txn, df)
    final_result_normal = combine_agent_scores(fraud_result_normal, behavior_result_normal,merchant_result_normal)
    ...
    merchant_result_fraud = analyze_merchant(fraud_txn, df)
    final_result_fraud = combine_agent_scores(fraud_result_fraud, behavior_result_fraud, merchant_result_fraud)
